...
<div class="content">
	<div class="formWrap clearfix">
		<h2>Edit Player</h2>
		<?php echo form_open_multipart('player/edit/' . $player->id); ?>

		<div class="inputGroup">
			<?php 
				echo form_label('First Name', 'first_name');
				echo form_input(array('name'=>'first_name', 'placeholder'=>'First Name'),set_value('first_name', $player->first_name));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'last_name', 'placeholder'=>'Last Name'),set_value('last_name', $player->last_name));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'email', 'placeholder'=>'Email'),set_value('email', $player->email));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'born', 'placeholder'=>'Born'),set_value('born', $player->born));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'last_year_rank', 'placeholder'=>'Last Year Rank'),set_value('last_year_rank', $player->last_year_rank));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'mobile', 'placeholder'=>'Mobile'),set_value('mobile', $player->mobile));
		...
		<div class="inputGroup">
			<?php 
				...
				echo form_input(array('name'=>'suncell', 'placeholder'=>'Suncell'),set_value('suncell', $player->suncell));
